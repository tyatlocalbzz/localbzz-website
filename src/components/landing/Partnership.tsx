  ...
  return (
    <section className="py-24 px-6 bg-white border-b-2 border-brand-dark">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Reveal>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl uppercase mb-8 leading-[1.1] text-brand-dark">
        ...
        <div className="border-l-4 border-brand-gold pl-8">
          ...
          <Reveal delay={0.1}>
            <p className="text-xl md:text-2xl text-brand-dark font-medium mb-6 leading-relaxed">
